...
const TokenRoadMap: FC<AboutProps> = ({ isRender, tokenExInVariants }) => {
    ...
    const roadmapItems = [
        { quarter: "Q1, Q2 2025", details: ["Project design and team formation", "Blockchain platform design and development", "Building a community and user base", "Securing investors and partners"], bg: "red.300"},
                        ...
                        {isTabletOrSmaller ? (
                            <>
                                ...
                                <Flex
                                    ...
                                    borderRadius="md"
                                >
                                    <Box bg="red.700" w={8} h={8} borderRadius="full" mb={4} />
