...
const Header : FC<HeaderProps> = ({tokenHomeRef, tokenServiceRef, tokenAboutRef, tokenRef, tokenRoadmapRef, contactRef }) => {
    ...
    return (
        ...
        <Flex
            ...
            bgColor={isScrolled ? "red.300" : "transparent"}
            alignItems="center"
        ...
        >
            ...
            as="a"
            href="/" >
                <Img w="80px" src="images/bonkydogelogo.png" zIndex={4}/>
                <Text w="160px" fontSize="24px" position="absolute" left="92px" top="20px">BonkyDoge</Text>
            </Flex>
